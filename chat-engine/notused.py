...
class RAG:
    ...
    def generate_queries(self, query_str, num_queries=3, llm=Gemini()):
...
if __name__ == "__main__":
    ...
    print(rag.answer("Bạn biết liên hệ với ai để kiến nghị hoặc phản ánh với Huyện ủy tại Trụ sở tiếp công dân cấp huyện?"))
